...
--
-- Host: localhost
-- Generation Time: 19 Jan 2018 pada 05.08
...
(31, 'test', '2018-01-12 16:35:10', '2018-01-12 16:35:10', '1', ''),
(32, 'test', '2018-01-12 16:35:23', '2018-01-12 16:35:23', '1', ''),
(33, 'test', '2018-01-12 16:36:18', '2018-01-12 16:36:18', '1', '');
...
INSERT INTO `reporter` (`id`, `name`, `date`, `tools_id`, `problems_id`, `confirm`, `imageUrl`) VALUES
...
--
-- Struktur dari tabel `running_id`
--
...
--
-- Indexes for table `running_id`
--
ALTER TABLE `running_id`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `running_id`
--
ALTER TABLE `running_id`
